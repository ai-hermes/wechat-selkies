...
RUN mkdir -p /app/rethink-ai && \
    case "$TARGETARCH" in \
      "amd64") MEM0_URL="https://github.com/ai-hermes/chatlog/releases/download/${MEM0_VERSION}/wechat-mem0-core_linux_amd64" ;; \
      "arm64") MEM0_URL="https://github.com/ai-hermes/chatlog/releases/download/${MEM0_VERSION}/wechat-mem0-core_linux_arm64" ;; \
      *) echo "❌ Unsupported architecture for wechat-mem0-core: $TARGETARCH" >&2; exit 1 ;; \
    esac && \
    curl -fsSL -o /app/rethink-ai/wechat-mem0-core "$MEM0_URL" && \
